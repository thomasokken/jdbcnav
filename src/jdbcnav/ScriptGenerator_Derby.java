...
public class ScriptGenerator_Derby extends ScriptGenerator {
	...
	// TODO: this method is a clone of the one in the DB2 driver; the only
	// change I made is to remove the GRAPHIC support (g'foo').
	// The assumption is that Derby, being originally IBM Cloudscape,
	// follows the same SQL literal syntax as IBM's DB2. Must check,
	// though.
	if (obj == null)
