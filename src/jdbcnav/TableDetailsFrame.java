...
public class TableDetailsFrame extends MyFrame {
    ...
    private TableModel buildTableModel() {
        String[] names = new String[] { "#", "Name", "Type", "Size",
                                "Scale", "Nulls", "Default", "Gen", "SQL Type",
                                "Java Type" };
        ...
        Object[][] data = new Object[columns][10];
        for (int i = 0; i < columns; i++) {
            ...
            data[i][7] = dbTable.getIsGenerated()[i];
            data[i][8] = MiscUtils.sqlTypeIntToString(spec.jdbcSqlType);
            data[i][9] = spec.jdbcJavaType;
        }
